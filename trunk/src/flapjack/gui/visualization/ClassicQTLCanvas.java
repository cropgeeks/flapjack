 ...
 */
class ClassicQTLCanvas extends JPanel implements PropertyChangeListener
{
	...
	ClassicQTLCanvas(GenotypePanel gPanel, GenotypeCanvas canvas, MapCanvas mapCanvas)
	{
		this.gPanel = gPanel;
		this.canvas = canvas;
