...
class NBTraitsImportingProgressPanel extends javax.swing.JPanel
{

	/** Creates new form NBSaveLoadPanel */
	public NBTraitsImportingProgressPanel()
	{
		initComponents();

		RB.setText(label, "gui.dialog.NBTraitsImportingProgressPanel.label");
	}
    ...
    private void initComponents() {
        ...
        label.setText("Importing trait data - please be patient...");
