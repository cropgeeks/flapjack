...
public class HeterozygousMarkersDialog extends JDialog implements ActionListener, ChangeListener
{
	...
	{
		RB.setText(bFilter, "gui.dialog.HeterozygousMarkersDialog.filter");
	...
	private void formatLabel()
	{
		percentLabel.setText(RB.format(
			"gui.dialog.HeterozygousMarkersDialog.percentLabel", value));
	}
