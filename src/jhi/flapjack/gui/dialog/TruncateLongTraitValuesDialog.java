...
public class TruncateLongTraitValuesDialog extends JDialog
{
	private GTViewSet viewSet;
	private ListPanel listPanel;
	
	public TruncateLongTraitValuesDialog(GTViewSet viewSet, ListPanel listPanel)
	{
		super(
			Flapjack.winMain,
			RB.getString("gui.dialog.TruncateLongTraitValuesDialog.title"),
			true
		);
	...
	private void initComponents2()
	{
		...
		RB.setText(chkTruncate, "gui.dialog.TruncateLongTraitValuesDialog.chkbox");
		chkTruncate.setSelected(Prefs.guiTruncateTraits);
		...
		truncateSpinner.addChangeListener(changeEvent ->
		{
			...
			Prefs.guiTruncateTraitsLength = (int)spinner.getValue();
			listPanel.populateList();
		});
	}
    ...
    private void initComponents() {
        ...
        chkTruncate.setText("Maximum trait value length:");
