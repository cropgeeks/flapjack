...
public class SelectMonomorphicMarkersDialog extends JDialog implements ActionListener
{
	...
	public SelectMonomorphicMarkersDialog(GTViewSet viewSet)
	{
		super(
			Flapjack.winMain,
			RB.getString("gui.dialog.analysis.SelectMonomorphicDialog.title"),
			true
		);
		...
		FlapjackUtils.initDialog(this, bSelect, bCancel, true, getContentPane());
	}
...
//		RB.setText(bFilter, "gui.text.ok");
    ...
    private void initComponents()
    {
        ...
        dialogPanel1.add(bSelect);

        bCancel.setText("Cancel");
        dialogPanel1.add(bCancel);

        jLabel1.setText("This will select all markers that are monomorphic across all of the currently selected lines.");

        csdLabel.setText("Choose which chromosomes to select across");
