...
public class IntertekFlapjackSnpSampleFileProcessor
{
	...
	public static void main(String[] args)
	{
		...
		try
		{
			...
			IntertekFlapjackSnpSampleFileProcessor intertekParser = new IntertekFlapjackSnpSampleFileProcessor(cl.getOptionValue("g"), cl.getOptionValue("i"), cl.getOptionValue("o"));
	...
	public IntertekFlapjackSnpSampleFileProcessor(String genotypeFileName, String intertekFileName, String outputFileName)
	{
