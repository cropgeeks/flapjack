...
class CmdOptions extends Options
{
    ...
    CmdOptions withCommonOptions()
    {
        ...
        addOption("N", "no-heterozygote-separator", false, "Expect heterozygotes to be separated by a string");
        addOption("S", "heterozygous-separator", true, "The string used to separate heterozygous alleles");
        addOption("M", "missing-data", true, "The string used to represent missing data");
